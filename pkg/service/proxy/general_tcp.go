...
func init() {
	pxyConfigs := []config.ProxyConfigurer{
		&config.TCPProxyConfig{},
		&config.HTTPProxyConfig{},
		&config.HTTPSProxyConfig{},
		&config.STCPProxyConfig{},
		&config.TCPMuxProxyConfig{},
	}
	for _, cfg := range pxyConfigs {
...
func NewGeneralTCPProxy(baseProxy *BaseProxy, _ config.ProxyConfigurer) Proxy {
