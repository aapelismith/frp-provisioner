...
func (c *HTTP2HTTPSPluginOptions) Validate() error {
	if c.LocalAddr == "" {
...
func (c *HTTPS2HTTPPluginOptions) Validate() error {
	if c.LocalAddr == "" {
		return errors.New("localAddr is required")
	}
	return nil
...
func (c *HTTPS2HTTPSPluginOptions) Validate() error {
	if c.LocalAddr == "" {
		return errors.New("localAddr is required")
	}
	return nil
...
func (c *StaticFilePluginOptions) Validate() error {
	if c.LocalPath == "" {
...
func (c *UnixDomainSocketPluginOptions) Validate() error {
	if c.UnixPath == "" {
